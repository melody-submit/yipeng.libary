...
public class FileAccessor {
    ...
    public static final String APPS_ROOT_DIR = getExternalStorePath() + "/jmtdc";
    public static final String EXPORT_DIR = getExternalStorePath() + "/jmtdc/ECDemo_IM";
    public static final String CAMERA_PATH = getExternalStorePath() + "/DCIM/jmtdc";
    public static final String TACK_PIC_PATH = getExternalStorePath()+ "/jmtdc/.tempchat";
    public static final String IMESSAGE_VOICE = getExternalStorePath() + "/jmtdc/voice";
    public static final String IMESSAGE_IMAGE = getExternalStorePath() + "/jmtdc/image";
    public static final String IMESSAGE_AVATAR = getExternalStorePath() + "/jmtdc/avatar";
    public static final String IMESSAGE_FILE = getExternalStorePath() + "/jmtdc/file";
    public static final String IMESSAGE_RICH_TEXT = getExternalStorePath() + "/jmtdc/richtext";
...
//
//            return   CCPAppManager.getHttpToken();
//
//        }else {
...
//            ToastUtil.showMessage(R.string.media_ejected);
    ...
    public static String getAppContextPath() {
        return WsApplication.getInstance().getFilesDir().getAbsolutePath();
    }
    ...
    public static File getTackPicFilePath() {
        File localFile = new File(getExternalStorePath()+ "/jmtdc/.tempchat" , "temp.jpg");
    ...
    public static String saveBitmap( Bitmap b) {
        ...
        String jpegName = getTackPicFilePath() + File.separator + "picture_" + dataTake + ".jpg";
        try {
