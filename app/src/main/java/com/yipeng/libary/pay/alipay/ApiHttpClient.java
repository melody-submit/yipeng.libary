...
public class ApiHttpClient {
	...
	private static String API_URL = "http://wx.ieo1.com/ddq/mobile/%s";

//	public final static String ALIPALY_RECHARGE_CALLBACK = "http://" + HOST + "/xjwd/mobile/recharge/zhifubao";//回调
//	public final static String ALIPALY_BUY_CALLBACK = "http://" + HOST + "/xjwd/mobile/order/zhifubao";//回调
	...
	public static void delete(String partUrl, AsyncHttpResponseHandler handler) {
		...
		log(new StringBuilder("DELETE ").append(getAbsoluteApiUrl(partUrl)).toString());
	}
	...
	public static void postKuaidi100(String partUrl, RequestParams params, AsyncHttpResponseHandler handler) {
	...
	public static void put(String partUrl, AsyncHttpResponseHandler handler) {
		...
		log(new StringBuilder("PUT ").append(getAbsoluteApiUrl(partUrl)).toString());
	}

	public static void put(String partUrl, RequestParams params, AsyncHttpResponseHandler handler) {
		client.put(getAbsoluteApiUrl(partUrl), params, handler);
		log(new StringBuilder("PUT ").append(getAbsoluteApiUrl(partUrl)).append("&").append(params).toString());
	}
